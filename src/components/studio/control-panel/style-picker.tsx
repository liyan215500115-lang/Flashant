...
const STYLES: StyleDef[] = [
  ...
  { key: "white", zh: "纯白底", en: "White BG", icon: Square,
    ...
    promptFlux: "Pure white background, soft even studio lighting, product centered with subtle ground shadow, commercial e-commerce packshot, 8K",
    promptFluxZh: "纯白背景，柔和均匀摄影棚灯光，产品居中带自然着地淡影，商业电商白底图，8K" },
  ...
  { key: "scene", zh: "场景图", en: "Lifestyle", icon: Image,
    ...
    promptFlux: "Bright modern room with natural window light, shallow depth of field, warm neutral tones, editorial home magazine quality, 8K",
    promptFluxZh: "明亮现代房间，自然窗光，浅景深，暖中性色调，家居杂志编辑品质，8K" },
  ...
  { key: "in_use", zh: "模特图", en: "Model", icon: User,
    ...
    promptFlux: "Person naturally using the product, candid moment, soft daylight, relaxed home or office setting, shallow focus on product, editorial lifestyle, 8K",
    promptFluxZh: "真人自然使用产品，抓拍瞬间，柔和日光，松弛家居或办公环境，焦点在产品的浅景深，编辑级生活方式，8K" },
  ...
  { key: "angles", zh: "多角度", en: "Multi-Angle", icon: Grid3X3,
    ...
    promptFlux: "Multi-angle product views on white background, front back side and top-down, consistent lighting, clean grid layout, 8K",
    promptFluxZh: "多角度产品图，白底，正面背面侧面俯视，统一灯光，干净网格布局，8K" },
  ...
  { key: "marble", zh: "奢华风", en: "Luxury", icon: Gem,
    ...
    promptFlux: "Marble or dark wood surface, soft directional light from upper left, generous negative space, desaturated warm tones, luxury editorial, 8K",
    promptFluxZh: "大理石或深色木纹台面，左侧上方柔定向光，大量留白，低饱和暖色调，奢华编辑级，8K" },
  ...
  { key: "natural", zh: "户外自然", en: "Outdoor", icon: Sun,
    ...
    promptFlux: "Golden hour outdoor setting, warm sunlight, soft bokeh greenery background, hazy atmosphere, natural organic aesthetic, 8K",
    promptFluxZh: "黄金时段户外场景，温暖阳光，柔和散景绿植背景，薄雾氛围，自然有机美学，8K" },
  ...
  { key: "cosy", zh: "温馨家", en: "Cosy Home", icon: Home,
    ...
    promptFlux: "Warm cosy interior, soft window light through linen curtain, natural linen and wood textures, candlelight, Scandinavian-Japandi aesthetic, hygge atmosphere, 8K",
    promptFluxZh: "温暖治愈室内，透过亚麻帘的柔和窗光，天然亚麻和木纹质感，烛光，北欧侘寂美学，治愈氛围，8K" },
  ...
  { key: "dark_moody", zh: "暗调高级", en: "Dark & Moody", icon: Coffee,
    ...
    promptFlux: "Dark charcoal background, single dramatic spotlight from upper right, deep shadows with sculptural contrast, cinematic mood, luxury brand aesthetic, 8K",
    promptFluxZh: "深炭黑背景，右上单光源戏剧性聚光，深邃阴影雕塑感对比，电影级氛围，奢侈品牌美学，8K" },
  ...
  { key: "cyberpunk", zh: "赛博朋克", en: "Cyberpunk", icon: Coffee,
    ...
    promptFlux: "Cyberpunk scene, wet reflective surface, cyan and magenta neon rim lights, volumetric fog, holographic grid background, Blade Runner aesthetic, 8K",
    promptFluxZh: "赛博朋克场景，湿润反光表面，青品红双霓虹轮廓光，体积雾，全息网格背景，银翼杀手美学，8K" },
  ...
  { key: "canvas", zh: "画布风", en: "Canvas Art", icon: Palette,
    ...
    promptFlux: "Art canvas backdrop, watercolor paper texture surface, flowing abstract pigment washes background, soft north window light, artist studio feel, 8K",
    promptFluxZh: "画布艺术背景，水彩纸纹理台面，流动抽象颜料渲染背景，柔北窗光，艺术家工作室感，8K" },
  ...
  { key: "kawaii", zh: "卡通风", en: "Kawaii", icon: Smile,
    ...
    promptFlux: "Candy pastel gradient background pink to lavender to blue, tiny floating stars and hearts, soft diffused light, cute playful atmosphere, clean product photography, 8K",
    promptFluxZh: "糖果粉彩渐变背景粉到紫到蓝，漂浮小星星和爱心，柔和漫射光，可爱俏皮氛围，干净产品摄影，8K" },
  ...
  { key: "infographic", zh: "信息图", en: "Infographic", icon: Image,
    ...
    promptFlux: "Product on white left side, clean information panel right side with icons and text, modern infographic layout, Amazon A+ style, 8K",
    promptFluxZh: "产品白底左侧，右侧干净信息面板带图标和文字，现代信息图布局，Amazon A+风格，8K" },
];
...
export function StylePicker({ value, onChange, onReferenceImage, onReferenceImageUploaded, engineType }: StylePickerProps) {
  ...
  function select(s: StyleDef) {
    // FLUX: img2img with input_images, prompt only needs scene description
    // Gemini/GPT: text-to-image, prompt needs full product+scene description
