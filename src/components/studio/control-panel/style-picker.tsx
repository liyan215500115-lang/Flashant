...
const STYLES: StyleDef[] = [
  ...
  { key: "in_use", zh: "模特图", en: "Model", icon: User, prompt: "The product being actively used or worn by a person. For wearables/earbuds: worn by a model showing fit. For kitchenware: hands cooking. Natural interaction, candid moment, soft daylight, authentic lifestyle photography, 4K", promptZh: "产品由真人模特佩戴或使用。穿戴设备/耳机：模特佩戴展示贴合感。厨具：手在烹饪。自然互动，抓拍瞬间，柔和日光，真实生活摄影，4K" },
