...
const STYLE_GUIDANCE: Record<string, { desc: string; guidance: string }> = {
  ...
  kawaii: {
    desc: "chibi kawaii collectible figurine aesthetic, 1:2 head-to-body proportions, oversized glossy round eyes with double catchlights, smooth cel-shaded gradients, glossy polished PVC vinyl finish, candy pastel gradient background (blush pink to lavender to baby blue), floating matte gold stars, sparkle bursts, pillow clouds, miniature hearts, macro ring light front, soft back rim light, 85mm macro lens f/5.6, Bandai/Sanrio premium blind box photography, square 1:1",
    guidance: "Describe an adorable kawaii product showcase. The product has been transformed into a cute collectible figurine. Focus on the joyful, whimsical, gift-worthy feeling. Describe the glossy finish, the pastel colors, the sparkles and hearts. Use words like 'adorable', 'kawaii', 'collectible', 'whimsical', 'joyful', 'premium toy'. Target emotion: pure delight.",
  },
  infographic: {
